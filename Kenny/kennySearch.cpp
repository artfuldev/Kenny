...
//	===========================================================================
	...
	if (movesLeft < 20) movesLeft = 20;
		...
		std::cout << "#-KENNY : in timecontrol, movesleft=" << movesLeft << std::endl;
	#endif
//	===========================================================================
...
//	===========================================================================
	...
	#ifdef KENNY_DEBUG_WINBOARD
		std::cout << "#-KENNY : in timecontrol, XB_CTIM=" << XB_CTIM << std::endl;
		std::cout << "#-KENNY : in timecontrol, XB_OTIM=" << XB_OTIM << std::endl;
		std::cout << "#-KENNY : in timecontrol, XB_INC =" << XB_INC << std::endl;
		std::cout << "#-KENNY : in timecontrol, maxtime=" << board.maxTime << std::endl;
	#endif
